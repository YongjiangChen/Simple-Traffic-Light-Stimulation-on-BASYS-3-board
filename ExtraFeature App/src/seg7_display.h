...
// Description: This header file contains definitions used to drive the 7 segment
// display. it contains Definitions for 7-segment BCD codes, Definitions for digit selection codes
// and Definitions for digit selection codes
/******************************************************************************/
